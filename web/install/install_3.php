					...
					<div class="gray_box">
						<div class="box">
							<table class="form_table">
								...
								<tr>
									<th>数据库表前缀</th>
									<td><input class="gray" type="text" value='we_' name='db_pre' /><br /><label class="error" id='db_pre_label' style='display:none'><img src="images/failed.gif" width="16" height="15" />请填写正确的表前缀字符</label></td>
								</tr>
								<tr>
